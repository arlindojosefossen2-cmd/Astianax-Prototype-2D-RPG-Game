...
/**
 * The Class HomePoraoScenne2.
 */
public final class HomePoraoScenne2 extends AbstractScenne
{
	
	/** The rect. */
	private final Rectangle rect = new Rectangle(16*GameConstants.TILESIZE, 16*GameConstants.TILESIZE, 64, 64);

	/** The home number. */
	public int homeNumber = 0;
	
	/**
	 * Instantiates a new home porao scenne 2.
	 *
	 ...
	 */
	public HomePoraoScenne2(final AbstractPlayer player,final Game game,final TileManager tmanager,final AbstractGameObject[] entities,
