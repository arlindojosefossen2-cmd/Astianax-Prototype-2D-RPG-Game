...
public final class City1Scenne extends AbstractScenne
{
	/** The rect. */
	private final GameRect rect = new GameRect(24*GameConstants.TILESIZE+16, 49*GameConstants.TILESIZE-32, 96,64);
	
	
	public City1Scenne(AbstractPlayer player, Game game, TileManager tmanager, AbstractGameObject[] entities,
	...
	public void updateScenne()
	{
		...
		if(rect.intersects(xPos,yPos,player.solidArea.getWidth(),player.solidArea.getHeight()))
		{
			...
			play.start();
			player.xPos = 28*GameConstants.TILESIZE-16;
			player.yPos = 20*GameConstants.TILESIZE-32;
