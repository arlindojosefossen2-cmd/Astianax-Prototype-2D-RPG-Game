 ...
 * 25 de jun. de 2025
 */
public final class HomeScenne1 extends AbstractScenne
{
	...
	/**
	 * Instantiates a new home scenne 1.
	 *
	 ...
	 */
	public HomeScenne1(final AbstractPlayer player,final Game game,final TileManager tmanager,final AbstractGameObject[] entities,
...
//		player.geteContainer().worldY/GameConstants.TILESIZE);	
		...
		if(rect.intersects(xPos,yPos,player.solidArea.getWidth(),player.solidArea.getHeight()))
		{
			...
			play.start();
			player.xPos = 14*GameConstants.TILESIZE-16;
			player.yPos = 7*GameConstants.TILESIZE-32;
